...
namespace RPGPlatformer.AIControl
{
    public class CombatPatrollerStateManager 
        : CombatPatrollerStateManager<CombatPatrollerStateGraph, CombatPatrollerStateMachine,
            IAIMovementController, AICombatController, CombatPatroller>
    //CombatPatrollerStateManager<CombatPatrollerStateGraph, CombatPatrollerStateMachine, 
    ...
    public class CombatPatrollerStateManager<T0, T1, T2, /*T20, T21, T22, T23,*/ T3, T4> 
        : AIPatrollerStateManager<T0, T1, T2, T4>//AIPatrollerStateManager<T0, T1, T2, T20, T21, T22, T23, T4>
        where T0 : CombatPatrollerStateGraph
        where T1 : CombatPatrollerStateMachine<T0>
        where T2 : IAIMovementController//GenericAIMovementController<T20, T21, T22, T23>
        ...
        where T4 : GenericCombatPatroller<T2, T3>//GenericCombatPatroller<T2, T20, T21, T22, T23, T3>
    {
