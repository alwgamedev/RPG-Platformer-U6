...
namespace SpriteShapeExtras
{
    ...
    public class GeometryCollider : MonoBehaviour
    {
        ...
        //I added (there was already a menu item to do this (see end of this script),
        //but I added a button to inspector just to make it easier)
        ...
        static public void Bake(GameObject go, bool forced)
        {
            ...
            if (spriteShapeController != null && polyCollider != null)
            {
                ...
                //List<Vector2> points = new List<Vector2>();//this was in here, but unused??
